...
const Modal = ({
  ...
  const modalContent = (
    ...
    >
      <div
        className={`relative w-full ${containerWidth} rounded-3xl bg-glam-surface p-6 shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto transition-all duration-300`}
